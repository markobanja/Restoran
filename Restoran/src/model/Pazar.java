...
public class Pazar {
	...
	public Pazar(int idracun, model.Jelo jelo, model.Pice pice, model.Konobar konobar, model.Restoran restoran,
			double cijena) {
		super();
	...
	public Pazar(model.Jelo jelo, model.Pice pice, model.Konobar konobar, model.Restoran restoran, double cijena) {
		super();
		Jelo = jelo;
		Pice = pice;
		Konobar = konobar;
